        ...
        <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0 justify-between">
            ...
            <div class="flex mr-6">
              <x-dropdown align="right" width="48">
                ...
                <x-slot name="trigger">
                    <button class="flex items-center text-xs sm:text-sm font-medium text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition duration-150 ease-in-out">
