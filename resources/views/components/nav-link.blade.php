...
$classes = ($active ?? false)
            ? 'inline-flex my-0 mx-auto px-2 md:px-4 py-1 border-b-2 border-gray-300 font-medium leading-5 text-gray-900 focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out'
